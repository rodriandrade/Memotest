...
function bonusScore(player){ // Puntaje extra
    if(player == 1){
        scoreOne = scoreOne + 10000000;
        document.getElementById(player).innerHTML = namePlayerOne + " " + ":" + " " + scoreOne + " " + "puntos";
    } else if(player == 2){
        scoreTwo = scoreTwo + 10000000;
        document.getElementById(player).innerHTML = namePlayerOne + " " + ":" + " " + scoreTwo + " " + "puntos";
    }
}
...
function matchesInfo(){ // Información de las partidas jugadas
    ...
    if(scoreOne > scoreTwo){
        ...
        document.getElementById("matchesOne").innerHTML = "Partidas ganadas por" + " " + namePlayerOne + ":" + " " + matchesOne;
    } else if(scoreTwo > scoreOne){
        matchesTwo = matchesTwo + 1;
        document.getElementById("matchesTwo").innerHTML = "Partidas ganadas por" + " " + namePlayerTwo + ":" + " " + matchesTwo;
    } else{
        ties = ties + 1;
